...
| Skill | Helps with |
|---|---|
| `frame-problem` | Getting from a vague request to a clear problem, business value, and next step |
| `shape-product-pitch` | Turning a framed problem and direction into a concise product pitch |
