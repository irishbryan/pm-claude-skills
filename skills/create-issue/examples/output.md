...
**tl;dr:** SSO users hit a dead end in password reset because the flow does not detect their auth method. Show a clear explanation and route them to SSO sign-in.
