...
**tl;dr:** The team agreed to ship the onboarding fix this week and delay the billing migration decision until vendor risk is clearer.

**Key Discussion Points:**
1. **The onboarding fix is ready to launch.** Support confirmed the known failure modes are covered by the current scope.
