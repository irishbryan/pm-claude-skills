...
|---|---|---|---|---|---|---|
| 1 | Bug | Upgrade checkout fails after customers change billing address | [Slack](#) | - | Untracked | High |
| 2 | Bug | Annual plan discount is not applied for existing accounts | [Slack](#) | - | Untracked | High |
| 3 | Bug | Invoice PDF download times out for accounts with many seats | [Slack](#) | [BILL-675](#) | Tracked | High |
| 4 | Request | Customer asked for invoice recipients to be managed by workspace admins | [Slack](#) | [BILL-415](#), [BILL-416](#) | Tracked | Medium |
